...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-slate-500 to-slate-600 max-w-7xl mx-auto rounded-b-lg">
      <div className=" text-sm   h-60 flex items-center text-slate-200 rounded-b-lg">
